...
//--------------------------------------------------------------------------
var applang = 'ar';
var httprootPath = "_content/Moamalat.Shared/";
var FirstLoad = true;
var myapp_config = {
    /*
    APP VERSION
...
////var NavMenuItem = document.querySelectorAll('.primary-nav');//.getElementsByTagName('li');
...
var initApp = (function (app) {
    ...
    */
    ...
    app.loadScript = function (scriptName, callback) {
        ...
        scriptName = '_content/Moamalat.Shared/' + scriptName;
            ...
            .on('click touchend', '[data-action]', function (e) {
                ...
                switch (true) {
                    ...
                    case (actiontype === 'lang'):
                        ...
                        applang = sender.attr('data-lang').toString();

                        ChangeLang(applang);

                        if (applang === 'ar') {
                            if (!sender.is('a'))
                                sender.attr('data-lang', 'en');

                            sender.removeClass('text-arabic');

                        }
                        else {
                            if (!sender.is('a'))
                                sender.attr('data-lang', 'ar');
                            $('span').removeClass('text-arabic');
                            sender.addClass('text-arabic');
...
function Localize(_Lang) {

   
    ChangeLang(applang);
   
    LocalizePageElements();

}
function LocalizePageElements() {
    $('html').attr('lang', applang);
    if (applang === 'ar') {
        $('link[href="' + httprootPath + 'css/vendors.bundle.css"]').attr('href', '' + httprootPath +'css/vendors.bundle-rtl.css');
        $('link[href="' + httprootPath + 'css/app.bundle.css"]').attr('href', '' + httprootPath +'css/app.bundle-rtl.css');

        $('body').addClass('rtl');

    }
    else {
        $('link[href="' + httprootPath + 'css/vendors.bundle-rtl.css"]').attr('href', '' + httprootPath +'css/vendors.bundle.css');
        $('link[href="' + httprootPath + 'css/app.bundle-rtl.css"]').attr('href', '' + httprootPath +'css/app.bundle.css');

        $('body').removeClass('rtl');
    }

    //if (applang === 'ar') {
    //    $('span .loc').addClass('text-arabic');
    //   // $('span .lang').removeClass('text-arabic');
    //}
    //else {

    //    $('span .loc').removeClass('text-arabic');
    //    //$('span .loc').addClass('text-arabic');
    //}
}
function ChangeLang(_Lang) {
    ...
    initApp.loadScript("js/i18n/i18n.js",
        function activateLang() {
            ...
            $.i18n.init({
                resGetPath: httprootPath + 'Localization/__lng__.json',
                load: 'unspecific',
                fallbackLng: false,
                lng: applang
            }, function (t) {
